...
import {
  ...
  semanticContext,
  snapshotFor,
  type AiOperatorAcceptanceTrace,
  type AiOperatorFallbackPlan,
} from './operator-acceptance-support.js';

export type { AiOperatorAcceptanceTrace, AiOperatorFallbackPlan } from './operator-acceptance-support.js';
