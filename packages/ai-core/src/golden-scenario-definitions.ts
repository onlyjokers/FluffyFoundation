...
import type { FixtureDefinition } from './golden-scenario-types.js';

export const displayDefinition = (type = 'display-breathing'): FixtureDefinition => ({
  type,
...
export const flashlightDefinition = (): FixtureDefinition => ({
